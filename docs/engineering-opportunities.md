...
| [EO-006 MCP error ownership](#eo-006-mcp-error-ownership) | 深化 | P2 | EO-005 后；需要契约影响确认 | `已晋升` |
...
| 2026-08-13 | EO-006 | 已晋升为独立 maintenance | [EO-006 maintenance](maintenance/EO-006-mcp-error-ownership.md) | 在最新 `origin/main` `521b892` 上重新验证 MCP client 与 Extension controller 的重复 client-message ownership 后建立 package-owned normalization 与 Host-only mapping seam |
