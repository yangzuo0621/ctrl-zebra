...
阶段 0–23 已完成，任务/PR/日期见[已完成任务历史](roadmap/archive/completed-tasks.md)，完整任务正文
均已按阶段归档。下表保留最近阶段的状态和归档入口；常规执行不读取已完成阶段归档。

| 阶段 | 状态 | 详细规格 |
|---|---|---|
| 21 | 已完成 | [阶段 21 归档](roadmap/archive/phase-21.md) |
| 22 | 已完成 | [阶段 22 归档](roadmap/archive/phase-22.md) |
| 23 | 已完成 | [阶段 23 归档](roadmap/archive/phase-23.md) |
