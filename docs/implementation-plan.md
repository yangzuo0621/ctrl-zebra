...
阶段 0–10 已完成，完整任务正文按阶段归档。阶段 11 已规划，任务正文保存在活动阶段目录。
...
| 11 | 计划中 | [阶段 11：用户体验成熟化](roadmap/phases/phase-11.md) |

## 6. 后续能力候选顺序

阶段 11 已选择为第一版发布后的下一阶段。完成体验成熟化后，建议按以下顺序评估：
...
阶段 0–10 的 76 个任务均已完成，目前没有进行中任务。下一任务为 T1101；领取前从最新 `main` 创建专用分支，并按任务模板同步状态与测试计划。
